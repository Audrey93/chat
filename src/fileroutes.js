...
var writePath = '/home/saurabh/Documents/react/chat/filestobeprinted/';
...
exports.fileprint = function (req, res) {
    ...
    jsonfile.readFile(filepath, function (err, obj) {
        var userid = obj.userid;
        client.query('SELECT * FROM collegeusers WHERE userid = ?', [userid], function (error, results, fields) {
            if (error) {
